...
private:
   ...
   // For prove (helper functions)
   void getLatchLevels(unsigned& minLevel, unsigned& maxLevel) const ;
   int minLengthToCounterExample(BddNodeV monitor) const ;
   void findCounterExample(BddNodeV monitor) const ;
};
