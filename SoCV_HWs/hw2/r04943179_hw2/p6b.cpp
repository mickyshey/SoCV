...
main()
{
   ...
   BddNode g4 = c & (b&d);				// c & g1
   cout << g4 << endl;

   BddNode g5 = (b&d) | (e&~c);			// g1 | g2
   cout << g5 << endl;

   BddNode g6 = d | (e&~c);				// d | g2
   cout << g6 << endl;

   BddNode g7 = (d | (e&~c)) & (a&b);				// g6 & g3
   cout << g7 << endl;

   BddNode g8 = ((d | (e&~c)) & (a&b)) | (c & (b&d));				// g7 | g4
   cout << g8 << endl;

   BddNode g9 = f & (((d | (e&~c)) & (a&b)) | (c & (b&d))) & ((b&d) | (e&~c));					// f & g8 & g5
   cout << g9 << endl;
