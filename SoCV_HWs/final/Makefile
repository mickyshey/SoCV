...
SRCPKGS	= cmd alg stg ext io trans vrf dfx svr adt bdd pdr itp ntk prove util v3mc

# library to be linked (should include SRCPKGS)
LIBPKGS	= vrf dfx stg trans alg ext ntk io ntk svr cmd adt prove bdd pdr itp ntk util v3mc
