...
const string V3CmdTypeString[] = {
   ...
   "ITP",  // MODIFICATION FOR SoCV ITP
   "PDR"   // MODIFICATION FOR SoCV PDR
};
...
enum V3CmdType
{
   ...
   CMD_TYPE_BDD         = 11,  // MODIFICATION FOR SoCV BDD
   CMD_TYPE_ITP         = 12,  // MODIFICATION FOR SoCV ITP
   CMD_TYPE_PDR         = 13,  // MODIFICATION FOR SoCV PDR
   CMD_TYPE_TOTAL       = 14   // MODIFICATION FOR SoCV 
};
