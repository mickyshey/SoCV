...
extern bool initItpCmd(); // MODIFICATION FOR SoCV ITP
extern bool initPdrCmd(); // MODIFICATION FOR SoCV PDR
...
int main(int argc, char** argv) {
   ...
   if (!(initAlgCmd() && initDfxCmd() && initNtkCmd() && initStgCmd() && initVrfCmd() &&
         ...
         && initBddCmd() && initProveCmd() && initItpCmd() && initPdrCmd() )) { // MODIFICATION FOR SoCV BDD
